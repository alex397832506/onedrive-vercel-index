...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'xdm@4bl308.onmicrosoft.com',
  ...
  protectedRoutes: ['/写真','/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route'],
